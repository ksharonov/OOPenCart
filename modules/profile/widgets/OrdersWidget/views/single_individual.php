                        ...
                        <div class="row">
                            <div class="col-md-28">
                                <div class="order__info">
                                    ...
                                    <?= $payments[$order->paymentMethod]->title ?? null ?>
                            ...
                            <div class="col-md-20">
                                <div class="order__controls">
                                    <div class="">
                                        <div class="order__label order__label_sum">Сумма скидки</div>
                                        <div class="order__value order__value_sum">
                                            <?= NumberHelper::asMoney($order->sumDiscount) ?> <span
                                                    class="rouble">₽</span>
                                        </div>
                                    </div>
                                    <div class="">
                                        <div class="order__label order__label_sum">Баллы начисленные</div>
                                        <div class="order__value order__value_sum">
                                            <?= NumberHelper::asMoney(0) ?> <span class="rouble">₽</span>
                                        </div>
                                    </div>
                                    <div class="">
                                        ...
                                        <?php } ?>
                                        <!--                                        <a href="#" class="order__submit">Сформировать счет</a>-->
                                    </div>
                                </div>
                            </div>
                        </div>

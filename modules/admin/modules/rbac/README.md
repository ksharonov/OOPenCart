...
'modules' => [
    'rbac' => [
        'class' => 'app\modules\admin\modules\rbac\Module',
        'as access' => [
            'class' => app\modules\admin\modules\rbac\filters\AccessControl::class
        ],
    ]
]
...
'modules' => [
    'rbac' => [
        'class' => 'app\modules\admin\modules\rbac\ConsoleModule'
    ]
]
```
...
use app\modules\admin\modules\rbac\migrations\Migration;
